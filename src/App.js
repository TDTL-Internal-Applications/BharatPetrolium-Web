...
import Cumulativepaymententries from "./Page/CumulativePaymentEntryNewDeposit"
...
import Scrutiny from "./Page/ScrutinyForm"
import LoanApprovals from "./ManagerPages/LoanApprovals";
import SharesApproval from "./ManagerPages/SharesApproval";
import NeftApproval from "./ManagerPages/NeftApproval"

import LoanApprovalFinal from "./BankTrusteeApproval/LoanApprovalFinal"
import SharesApprovalFinal from "./BankTrusteeApproval/SharesApprovalFinal"
import NeftFinalApproval from "./BankTrusteeApproval/NeftApprovalFinal";
import MemberShareholders from "./MemberPages/MemberShareholders"
import MemberBankDetails from "./MemberPages/MemberBankDetails";
import MemberNomineeDetails from "./MemberPages/MemberNomineeDetails"
import MemberBankBalance from "./MemberPages/MemberBankBalance"
import LoanApprovalReports from "./ManagerPages/LoanApprovalReports";
import ApprovedShares from "./ManagerPages/ApprovedShares";
    ...
    <div className="App">
      {/* <Router> */}
        ...
        <Route path="/view-member-details" element={<ViewMemberDetails toChangeMemberId={toChangeMemberId}/>} />
         ...
         <Route path="/approved-shares" element={<MemberShareholders/>}></Route>
         <Route path="/members-bank-details" element={<MemberBankDetails/>}></Route>
         <Route path="/members-nominee-details" element={<MemberNomineeDetails/>}></Route>
         <Route path="/members-bank-balance" element={<MemberBankBalance/>}></Route>
         ...
         <Route path="/account-head" element={<Head/>}></Route>
         <Route path="/scrutiny-form" element={<Scrutiny/>}></Route>
        ...
        <Route path="/otp-verfication" element={<ForgotPassword2 forgotPasswordEmail={forgotPasswordEmail}/>} />
         ...
         {/* Manager Pages */}
         <Route path="/loan-approvals" element={<LoanApprovals/>}></Route>
         <Route path="/shares-approvals" element={<SharesApproval/>}></Route>
         <Route path="/neft-approvals" element={<NeftApproval/>}></Route>
         <Route path="/approved-loan" element={<LoanApprovalReports/>}></Route>
         <Route path="/all-approved-shares" element={<ApprovedShares/>}></Route>




         {/* Trustee Pages */}
         <Route path="/final-loan-approvals" element={<LoanApprovalFinal/>}></Route>
         <Route path="/final-share-approvals" element={<SharesApprovalFinal/>}></Route>
         <Route path="/final-neft-approvals" element={<NeftFinalApproval/>}></Route>
