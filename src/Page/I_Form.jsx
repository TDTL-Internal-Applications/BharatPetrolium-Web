...
export default function ShareHolderColumn() {
    ...
    async function forIForm()
    {
        ...
        try {
            ...
            const memberInfo=response.data.data.member_details;
            setShareHeldInfo(response.data.data.shareheld_details);
            setFormData({
                membershipNo: memberId,
                dateOfAdmission: memberInfo.Date_of_Admission,
                dateOfPaymentEnteranceFee: memberInfo.payment_date,
                fullName: memberInfo.full_name,
                address: memberInfo.Address,
                permanentAddress: memberInfo.Permanent_Address,
                occupation: "",  
                ageAndDateOfAdimission: memberInfo.Age_on_Admission.toString(),
                nameAndAddOfNominee: memberInfo.nominee_name,
                dateOfNomination: memberInfo.Nomination_date,
                dateOfCessationMembership: memberInfo.Cessation_date,
                reasonOfCessation: "",
                remarks: "",
            });
                              ...
                              <tbody>
                                {
                                    shareHeldInfo.map((element)=>{
                                      return ( <tr className="table-row">
                                            ...
                                            <td className="table-data">{element.From}</td>
                                            <td className="table-data">{element.To}</td>
