                                        ...
                                        <div class="no-outline-login">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    handleInputChange({
                                                        target: { name: "certificate_no", value: numericValue },
                                                    });
                                                }} />
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        handleInputChange({
                                                            target: { name: "old_acc_no", value: numericValue },
                                                        });
                                                    }}
                                                />
                                            </div>
                                        </div>
                                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 text-start" style={{ color: "red" }}        >
                                        ...
                                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 text-start">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    handleInputChange({
                                                        target: { name: "effectAmount", value: numericValue },
                                                    });
                                                }}
                                                min={0}
                                            />
                                        ...
                                        <div className="col-sm-3">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    handleInputChange({
                                                        target: { name: "introducerNo", value: numericValue },
                                                    });
                                                }}
                                            />
                                        </div>
