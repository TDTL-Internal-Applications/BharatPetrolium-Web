...
export default function EkLakshaYojanaDeposit() {
  const [memberNumbers, setMemberNumbers] = useState([]);
  let [invalid, setInvalid] = useState(Array.from({ length: 4 }, () => false));
    ...
    axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          icon: "success",
          title: "Thank You!",
          text: "Ek Laksha Yojana deposit created successfully!",
          didOpen: () => {
      ...
      if (deposit_period !== undefined && deposit_period !== "") {
        if (StartDate !== undefined && StartDate !== "") {
          fetch("http://bpcl.kolhapurdakshin.com:8000/Calculate_amt/", {
            ...
            .then((data) => {
              console.log(data);
              // const maturityAmtValue = data.maturity_amt;
  ...
  // const handleInputChangeFor = async (MonthlyDeposit, deposit_period, StartDate) => {
  //   try {
  ...
  //     if (MonthlyDeposit && deposit_period && StartDate) {
  //       const response = await fetch("http://bpcl.kolhapurdakshin.com:8000/Calculate_amt/", {
  //         method: "POST",
  //         headers: {
  //           "Content-Type": "application/json",
  //         },
  ...
  //       const maturityAmtValue = data.total_value;
  ...
  //         deposit_period: deposit_period,
  //         StartDate: StartDate,
  //         maturityOn: data.error === "Not Eligible" ? "" : data.maturity_date,
  //         MaturityAmt: data.error === "Not Eligible" ? "" : maturityAmtValue,
  //         interestAmount: data.interest_amount,
  //         InterestRate: data.interest_rate,
  //       });
  //     }
      ...
      .then((ress) => {
        if (ress.data.members && ress.data.members.length > 0) {
          ...
          setFormData((prevData) => ({
            ...
            member_class: memberData["member_class"],
          }));
        } else {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main d-flex align-items-center"><RiBankFill style={{color:"cadetblue",fontSize:"1.7rem"}}/>&nbsp;Ek Laksha Yojana Deposit</div>
          </div>

          <div className="container">
            {/* Your first form code */}
            <div className="row First-Main-Row  pt-3 pb-3  mb-2">
              {/* Basic Information  */}
              <form>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 text-start">
                      ...
                      <div>
                        <input
                          ...
                          className={
                            invalid[1]
                              ? "form-control small-label bg-white border-danger"
                              : "form-control small-label bg-white"
                          }
                          id="floatingInput"
                          name="StartDate"
                      ...
                      <div>
                        <div className="row">
                          ...
                          <div className="col-sm-6">
                            <label
                              className="form-control small-label Background-color-text bg-white"
                              id="floatingInput"
                              style={{ width: "100%" }}
                            >
                              Months
