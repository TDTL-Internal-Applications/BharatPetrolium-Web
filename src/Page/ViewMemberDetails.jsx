...
import view from "../Images/search_1979260.png";
      ...
      .then((ress) => {
        if (ress.data.members && ress.data.members.length > 0) {
          ...
          setFormData((prevData) => ({
            ...
            Issued_at: memberData["Issued_at"],
            Issued_on: memberData["Issued_on"],
            addressProof: memberData["address_proof"],
            addressProof_No: memberData["addressno"],
            address_issued_at: memberData["address_issued_at"],
            address_issued_on: memberData["address_issued_on"],
            ...
            retire_on: memberData["retire_on"],
            profile_photo: memberData["profile_img"],
          }));
        } else {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"><img src={view} alt="" style={{ height: "27px" }} /> View Member Details</div>
          </div>
            ...
            <div className="row w-100 ">
              ...
              <form>
                ...
                <div className="row basic-info" >
                  ...
                  <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 d-flex align-items-center justify-content-center">
                    <div className="Profile-img">
                      ...
                      {formData.member_id ? (
                        ...
                        formData.profile_photo ? (
                          ...
                          <img
                            src={`http://bpcl.kolhapurdakshin.com:8000/path/to/profile/images/${formData.profile_photo}`}
                            alt="Member Profile"
                          />
                        ) : (
                          // 2. Display placeholder image if no profile photo is available
                          <div>
                            <img
                        ...
                        // 3. Display normal placeholder image when member ID is empty
                        <img
                          src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg" // Provide the path to your placeholder image
                          alt="Normal Placeholder Profile"
                        />
                      )}
                    </div>
                  </div>
                ...
                {/* Address Details */}
                <div className="H2-Sub-Heading pt-1 ">Address Details</div>
                ...
                <div className="row">
                  <div className="col-xl-6">
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-6 col-lg-4 col-md-6 col-sm-3 text-start">
                        <div class="no-outline-login">
                ...
                {/* Service Details */}
                <div className="H2-Sub-Heading pt-1 ">Service Details</div>
                ...
                {/* Monthly Contrubution */}
                <div className="H2-Sub-Heading pt-1 ">Monthly Contribution</div>
                ...
                {/* <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 text-start ">
                    ...
                    <div>
                      <input
                        ...
                        value={formData.address_issued_at}
                        className="form-control small-label"
                        readOnly
                ...
                {/* <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 text-start">
                    <div class="">
                      ...
                      <input
                        ...
                        readOnly
                        value={formData.address_issued_on}
                        // onChange={handleInputChange}
                      />
                    </div>
                  </div> */}
                ...
                {/* Nominee Details */}
                <div className="H2-Sub-Heading pt-1 ">Nominee Details</div>
                ...
                {/* <div className="row">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-4 col-sm-3 text-start">
                    <label htmlFor="member_no" className="small-label">
                      Member No.
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-xl-7 col-lg-6 col-md-6 col-sm-6 text-start">
                    <label htmlFor="member_name" className="small-label">
                      Name
                    </label>
                    <input
                      type="text"
                ...
                {/* Bank Details */}
                <div className="H2-Sub-Heading pt-1 ">Bank Details</div>
                          ...
                          >
                            <div className="col-12">
                              <form>
                                ...
                                <div className="H1-Heading-Main mt-2 mb-2">
                                  Nomination Register
                                </div>
