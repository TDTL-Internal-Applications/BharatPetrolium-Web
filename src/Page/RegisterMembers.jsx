...
export default function RegisterMembers() {
  ...
  const handleUpdate = async (member_id) => {
    ...
    console.log(data)
    try {
      const response = await axios.get(`http://127.0.0.1:8000/all_memberdata/${member_id}/`);
  ...
  const columns = [
    ...
    },
    {
      name: "Delete",
      cell: (row, rowIndex) => (
        <button className="btn btn-danger" onClick={() => handleDelete(row.member_id)}>Delete</button>
      ),
      center: true,
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-sm-12">
          ...
          >
            <h2 style={{ color: "darkblue", fontSize: "28px", fontWeight: "bold", paddingBottom: "15px", }}>
        ...
        <div className="modal-dialog modal-dialog-centered" role="document" style={{ maxWidth: "800px" }}>
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary"  onClick={handleSaveChanges}>
                Save changes
              </button>
            </div>
          </div>
