...
export default function CashCertificateDeposit() {
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-9 ">
                          <input
                            ...
                            id="memberId"
                            name="member_id"
                            class={(invalid[0])?"form-control small-label border-danger":"form-control small-label"}
                            // placeholder="Enter Member No"
                            value={formData.member_id}
                            // onChange={handleMemberIdChange}
                            onChange={(e) => {
                  ...
                  <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6 text-start">
                    ...
                    <div className="">
                      <input
                        ...
                        //   );
                        //   handleInputChange({
                        //     target: { name: "bankName", value: alphaValue },
                        //   });
                        // }}
                      />
                    </div>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 text-start">
                    ...
                    <div className="">
                      <input
                        ...
                        //   );
                        //   handleInputChange({
                        //     target: { name: "bankAcNo", value: numericValue },
                        //   });
                        // }}
                      />
                    </div>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 text-start">
                    ...
                    <div className="">
                      <input
                        ...
                        //   );
                        //   handleInputChange({
                        //     target: { name: "branchName", value: alphaValue },
                        //   });
                        // }}
                      />
                    </div>
                ...
                <div className="Border-Black px-2 py-2 mb-3">
                  <div className="row">
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 text-start">
                      <label
                        htmlFor="floatingInput"
                        className="small-label bg-white"
                      >
                        Maturity On
                      </label>
                      <div>
                ...
                <div className="row">
                  <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 text-start">
                    ...
                    <input
                      ...
                      //   );
                      //   handleInputChange({
                      //     target: { name: "nomineeName", value: alphaValue },
                      //   });
                      // }}
                    />
                  </div>
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 text-start">
                    ...
                    <input
                      ...
                      //   );
                      //   handleInputChange({
                      //     target: { name: "nomineeAge", value: numericValue },
                      //   });
                      // }}
                    />
                  </div>
