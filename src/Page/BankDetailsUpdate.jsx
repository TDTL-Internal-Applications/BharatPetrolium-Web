...
export default function BankDetailsUpdate() {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const isDataChanged = Object.keys(updatedMemberData).some(
        (key) => updatedMemberData[key] !== selectedMemberData[key]
      );
              ...
              <form>
                <div className="Border-Black px-2 py-2 mb-3">
                  <div className="row mb-2">
                    ...
                    <div className=" col-xl-4 col-lg-4 col-md-5 col-sm-5 form-fields">
                      <label
                        htmlFor="text"
