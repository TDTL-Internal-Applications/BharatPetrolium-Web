...
export default function Recurring() {
  ...
  const closeDepositAndFetchDetails = async (memberId, rdId) => {
    const response = await fetch("http://bpcl.kolhapurdakshin.com:8000/close_rd/", {
      method: "PATCH",
      headers: {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
           ...
           <div className="row pb-0">
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0">
                  <label className="label-font" htmlFor="bankName ">Bank Name*</label>
                  <input
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0">
                  <label className="label-font" htmlFor="branchName">Branch Name*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="branchName"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0">
                  <label className="label-font" htmlFor="ifscCode">IFSC CODE*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="ifscCode"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="micrCode">MICR Code*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="micrCode"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="bankAcNo">Bank A/c No*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="bankAcNo"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="uidNo">UID No*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="uidNo"
            ...
            <div className="row pb-0 mb-0">
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 pb-0 ">
                  <label className="label-font" htmlFor="openDate">Open Date*</label>
                  <input
                    className="form-control"
                    type="date"
                    id="openDate"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="instalment">Instalment*</label>
                  <input
                    className="form-control"
                    type="number"
                    id="instalment"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <label className="label-font" htmlFor="period ">Period*</label>
                <input
                  className="form-control no-outline-login"
                  type="number"
                  id="period"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="maturity">Maturity*</label>
                  <input
                    className="form-control"
                    type="date"
                    id="maturity"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group mb-0 ">
                  <label className="label-font" htmlFor="amount">Amount*</label>
                  <input
                    className="form-control"
                    type="text"
                    id="amount"
              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 text-start">
                <div className="form-group">
                  <label className="label-font" htmlFor="accountOpeningType">A/c Opening Type</label>
                  <select
          ...
          {/* <div className="container d-flex  w-100">
            <div className="row pb-2 d-flex justify-content-start align-items-center">
              ...
              <div className="col-2 py-1">
                <button
                  ...
                  className="btn btn-success no-outline"
