    ...
    axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          icon: "success",
          title: "Thank You!",
          text: "Term deposit created successfully!",
          didOpen: () => {
      ...
      .then((ress) => {
        if (ress.data.members && ress.data.members.length > 0) {
          ...
          setFormData((prevData) => ({
            ...
            nativeplace_pincode: memberData["resident_pincode"],
            nativeplace_city: memberData["resident_city"],
        ...
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main d-flex align-items-center">
              <RiBankFill style={{ color: "cadetblue", fontSize: "1.7rem" }} />
              &nbsp; Term Deposit
            </div>
          </div>
          <div className="container">
            ...
            <div className="row First-Main-Row  pt-3 mb-3">
              ...
              <form>
                ...
                <div className="Border-Black px-2 py-3 mb-3">
                  <div className="row">
