...
export default function LakhpatiYojana() {
    ...
    axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          icon: "success",
          title: "Thank You!",
          text: "Lakhpati Yojana deposit created successfully!",
          didOpen: () => {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"> Lakhpati Yojana Deposit</div>
          </div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              handleMemberIdChange({
                                target: { name: "member_id", value: numericValue },
                              });
                            }}
                            min={0}
                            required
                    ...
                    <div className="">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleJoinName2Change({
                            target: { name: "renewalExtra", value: numericValue },
                          });
                        }}
                      />
                    </div>
