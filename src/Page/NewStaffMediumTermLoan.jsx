...
import laonimg from "../Images/salary_3135679.png";
    ...
    axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          icon: "success",
          title: "Thank You!",
          text: "Staff Medium Term Loan has been Granted successfully.",
          didOpen: () => {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"> <img src={laonimg} alt=""style={{height:"35px"}} />&nbsp; New Staff Medium Term Loan </div>
          </div>
