...
export default function TransactionStaffMediumTermLoan() {
    ...
    // }
    let input2={
        RDID: <input type="number" style={{ width: '100%',textAlign:'center' }} value={loanNo} onChange={(e) => { setLoanNo(e.target.value) }} readOnly />,
        member_id: <input type="number" style={{ width: '100%',textAlign:'center' }} value={sanction} onChange={(e) => { setSanction(e.target.value) }} readOnly />,
        MonthlyDeposit: <input type="number" style={{ width: '100%' ,textAlign:'center'}} value={loanAmount} onChange={(e) => { setLoanAmount(e.target.value) }} readOnly />,
        InterestRate: <input type="date" style={{ width: '100%',textAlign:'center' }} value={loanDate} onChange={(e) => { setLoanDate(e.target.value) }} readOnly />,
        deposit_period: <input type="number" style={{ width: '100%',textAlign:'center' }} value={interestRate} onChange={(e) => { setInterestRate(e.target.value) }} readOnly />,
        MonthlyDeposit: <input type="number" style={{ width: '100%',textAlign:'center' }} value={period} onChange={(e) => { setPeriod(e.target.value) }} readOnly />,
        MonthlyDeposit: <input type="number" style={{ width: '100%',textAlign:'center' }} value={installment} onChange={(e) => { setInstallment(e.target.value) }} readOnly />,
        MonthlyDeposit: <input type="number" style={{ width: '100%',textAlign:'center' }} value={firstDueDate} onChange={(e) => { setFirstDueDate(e.target.value) }} readOnly />,
        MonthlyDeposit: <input type="number" style={{ width: '100%',textAlign:'center' }} value={dueDate} onChange={(e) => { setDueDate(e.target.value) }} readOnly />,
    }
