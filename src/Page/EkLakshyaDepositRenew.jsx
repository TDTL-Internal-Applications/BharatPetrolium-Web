...
export default function EkLakshaYojanaDepositRenew() {
    ...
    axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          icon: "success",
          title: "Thank You!",
          text: "Ek Laksha Yojana deposit renewed successfully!",
          didOpen: () => {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"><MdEventRepeat style={{fontSize:"32px",color:"orange"}}/>&nbsp;Renew Ek Laksha Yojana Deposit
            </div>
          </div>
