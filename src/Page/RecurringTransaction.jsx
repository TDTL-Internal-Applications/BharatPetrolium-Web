...
export default function RDTansactions() {
  ...
  const handleSelectChange = (event) => {
    ...
    setSelectedOption(selectedValue);
    // setTotalAmount(totalAmount); // Update this part with your logic to set totalAmount

    // Handle modal opening and set totalAmount
  ...
  const handleViewTransactions = (member_id, RDID) => {
    ...
    let dataArray = [];
    let inputObject = {
      transactionDate: <input type="date" className="inputFields" value={getCurrentDate} required/>,
      rvno: <input type="text" className="inputFields" required/>,
      particular: <select type="text" className="inputFields" required
      ...
      total_amount: <input type="text" value={totalAmount} className="inputFields" required/>,
    ...
    axios
      ...
      .then((response) => {
        ...
        const lastTransaction = data[data.length - 1];
          ...
          const RDID = lastTransaction.RDID || ""  
                            ...
                            <div className="row mb-1">
                              ...
                              <div class="col-sm-12">
                                <select
                                  ...
                                  class="form-control no-outline-login"
                                  id="inputTransfer3"
                                  value={selectedOption === 'Transfer' ? memberDetails?.bank_name : selectedOption}
                                  disabled={selectedOption === 'By Cash'}
                                  onChange={(e) => handleSelectChange(e)} //  
                    
                                >
                                  <option>{memberDetails && memberDetails.bank_name}</option>
