...
export default function RDTansactions() {
  ...
  const handleViewTransactions = (member_id, RDID) => {
    ...
    let inputObject = {
      ...
      RV_no: <input type="text" name="rv_no" placeholder="Rv No"  className="inputFields" required ref={RvNo} 
       />,
      particular: (
        <select
          type="text"
      ...
      cheque_no: <input type="text" placeholder="Cheque NO" name="cheque_no" className="inputFields" ref={cheque} required />,
      debit: <input type="text" placeholder="Debit"  className="inputFields" required />,
      original_amount: <input type="text" className="inputFields" required value={deposit && deposit.MonthlyDeposit} />,
      total_amount: (
        <input
          type="text"
          id="Balance"
  ...
  const closeDepositAndFetchDetails = async (memberId, rdId) => {
    const response = await fetch(
      "http://bpcl.kolhapurdakshin.com:8000/rd_transaction/",
      {
        method: "PATCH",
        headers: {
                    ...
                    <>
                      {memberTransactions && (
                        <DataTable
                          ...
                          data={memberTransactions.sort((a, b) => b.timestamp - a.timestamp)}                          
