...
import Transaction_Img from "../Images/money-flow_13340994.png"
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container-fluid ps-0 d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"><img src={Transaction_Img} alt="" style={{height:"40px"}}/> All Loan Transaction</div>
          </div>
