...
export default function ViewStaffMediumTermLoan() {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main">View Staff Medium Term Loan </div>
          </div>
            ...
            <div className="row First-Main-Row  pt-2 mb-1">
              <form>
                  ...
                  <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 text-start">
                    ...
                    <div className="mb-1">
                      <input
                        ...
                        onChange={(e) => {
                          const numericValues = e.target.value.replace(
                            /[^0-9.]/g,
                            ""
                          );
                          const sixDigitValuess = numericValues.slice(0, 6);
                          handleInputChange({
                            target: {
                              name: "pinCode",
                              value: sixDigitValuess,
                            },
                          });
                        }}
                    ...
                    <div class="no-outline-login">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          const nineDigitvalues = numericValue.slice(0, 10);
                          handleInputChange({
                            target: {
                              name: "mobileNumber",
                              value: nineDigitvalues,
                            },
                          });
                        }}
                ...
                <div className="row ">
                  ...
                  <div className="col-xl col-lg-2 col-md-6 col-sm-6  text-start">
                    <div className="">
                      <label htmlFor="recoveryUser" className="small-label">
                        Recovery User*
                      </label>
                      <input
                        type="text"
                ...
                <div className="row">
                  <div className="col-xl col-lg-3 col-md-6 col-sm-6  text-start">
                    <div className="">
                      ...
                      <input
                        type="number"
                        id="loanSecurityField1"
                        name="loanSecurityField1"
                        className="form-control small-placeholder"
                        value={formData.loanSecurityField1}
                        onChange={(e) => {
                          handleInputChange({
                            target: {
                              name: "loanSecurityField1",
                  ...
                  <div className="col-xl col-lg-3 col-md-6 col-sm-6  text-start">
                    <div className="">
                      <label
                        htmlFor="loanSecurityField2"
                        className="small-label"
                      ></label>
                      <input
                        type="text"
                        id="loanSecurityField2"
                        name="loanSecurityField2"
                        className="form-control small-placeholder"
                        value={formData.loanSecurityField2}
                        onChange={(e) => {
                          handleInputChange({
                            target: {
                              name: "loanSecurityField2",
                    ...
                    <div className="">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: { name: "recovery", value: numericValue },
                          });
                        }}
                        required
                      />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6  text-start">
                    <div className="">
                      ...
                      <select
                        ...
                        className="form-control small-placeholder form-select"
                        value={formData.sanctionCommittee}
                        onChange={(e) => {
                          handleInputChange({
                            target: {
                              name: "sanctionCommittee",
                      ...
                      >
                        {/* Add options for the select dropdown based on your requirements */}
                        <option value="">Select Sanction Committee</option>
                ...
                <div className="Border-Black px-2 mt-3 pb-2">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-start">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: { name: "fieldName1", value: alphabeticValue },
                          });
                        }}
                        required
                      />
                    </div>
                    {/* Surety 1 Mobile Number */}
                    <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6 text-start">
                      <div className="">
                        <label
                          htmlFor="mobileNumberSurety1"
                          className="small-label"
                        >
                          Mobile Number*
                        </label>
                        <input
                          type="tel"
                          id="mobileNumberSurety1"
                          name="mobileNumberSurety1"
                          value={formData.mobileNumberSurety1}
                          className="form-control small-placeholder"
                          onChange={(e) => {
                            const numericValue = e.target.value.replace(
                              /[^0-9.]/g,
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-start">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: { name: "fieldName2", value: alphabeticValue },
                          });
                        }}
                        required
                      />
                    </div>
                    {/* Surety 2 Mobile Number */}
                    <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6 text-start">
                      <div className="">
                        <label
                          htmlFor="mobileNumberSurety2"
                          className="small-label"
                        >
                          Mobile Number*
                        </label>
                        <input
                          type="tel"
                          id="mobileNumberSurety2"
                          name="mobileNumberSurety2"
                          value={formData.mobileNumberSurety2}
                          className="form-control small-placeholder"
                          onChange={(e) => {
                            const numericValue = e.target.value.replace(
                              /[^0-9.]/g,
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-start">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: { name: "fieldName3", value: alphabeticValue },
                          });
                        }}
                        required
                      />
                    ...
                    {/* Surety 3 Mobile Number */}
                    <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6 text-start">
                      <div className="">
                        <label
                          htmlFor="mobileNumberSurety3"
                          className="small-label"
                        >
                          Mobile Number*
                        </label>
                        <input
                          type="tel"
                          id="mobileNumberSurety3"
                          name="mobileNumberSurety3"
                          value={formData.mobileNumberSurety3}
                          className="form-control small-placeholder"
                          onChange={(e) => {
                            const numericValue = e.target.value.replace(
                              /[^0-9.]/g,
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-start">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: { name: "fieldName4", value: alphabeticValue },
                          });
                        }}
                        required
                      />
                    </div>
                    {/* Surety 4 Mobile Number */}
                    <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6 text-start">
                      <div className="">
                        <label
                          htmlFor="mobileNumberSurety4"
                          className="small-label"
                        >
                          Mobile Number*
                        </label>
                        <input
                          type="tel"
                          id="mobileNumberSurety4"
                          name="mobileNumberSurety4"
                          value={formData.mobileNumberSurety4}
                          className="form-control small-placeholder"
                          onChange={(e) => {
                            const numericValue = e.target.value.replace(
                              /[^0-9.]/g,
