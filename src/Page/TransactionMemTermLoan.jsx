...
export default function TransactionMemTermLoan() {
  ...
  async function handlePayment() {
    ...
    try {
      ...
      let jsonData = responseNew.data;
      console.log(jsonData);
      Swal.fire({
        icon: "success",
        title: "Success",
        html: `<div style="text-align: center; font-size: 16px; background-color: #f5f5f5; border: 2px solid #4CAF50; padding: 10px; border-radius: 25px;">
      <p style="margin-bottom: 10px;">Transaction successful</p>
      <strong style="color: #4CAF50;">Full Name:</strong> ${
        MemberIdForDataTable === "" ? "" : fullName
      }<br>
      <strong style="color: #4CAF50;">Loan No:</strong> ${
        MemberIdForDataTable === "" ? "" : loanNo
      }
      </div>`,
      didOpen: () => {
      ...
      // Further logic to update UI or perform additional actions with jsonData
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (btnSuccess) {
      btnSuccess.addEventListener("click", handlePayment);
    }
  });
  ...
  const [selectTagValue, setSelectTagValue] = useState("Repayment Entry");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const dataPost = {
          member_id: MemberIdForDataTable,
        };

        if (!MemberIdForDataTable) {
          setData("");
          return;
        }
        ...
        const dataArray = jsonData.transactions;
        setNewTotal(dataArray[0].total);
        setNewBalance(dataArray[0].balance);
        setData(dataArray);
      } catch (error) {
      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main"> Transaction Medium Term Loan</div>
          </div>
