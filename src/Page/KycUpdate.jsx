...
export default function KYCUpdation() {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      Swal.fire({
        title: "Success",
        text: "KYC Details Successfully Updated.",
        icon: "success",
        didOpen: () => {
          Swal.getPopup().style.borderRadius = "25px";
          const confirmButton = Swal.getConfirmButton();
            ...
            >
              ...
              <form>
                ...
                <div className="row pb-1">
                  <div className="col-xl-3 col-lg-1 col-md-6 col-sm-6 text-start">
                  ...
                  <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 text-start">
                    ...
                    <input
                      ...
                      id="uid_no"
                      name="uid_no"
                      value={updatedMemberData.uid_no}
                      onChange={handleInputChange}
                      maxLength={12}
                    />
                  </div>
                ...
                <div className="row mb-3">
                  <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 form-fields">
                    <label htmlFor="text" className="small-label">
                      Posting*
                    </label>
                    <select
