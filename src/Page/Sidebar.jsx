    ...
    >
          ...
          {showLoanMenus && (
            <ul>
              ...
              <li onClick={stopPropagation} className="submenu-loan">
                ...
                >
                  <div className="ps-2 text-start">Staff Med Term Loan</div>
                  <i
                    className={`dropdown-icon ${
      ...
      {userRole === "Member" && (
        <ul className="nav-list">
          ...
          <li>
            <Link to="/under-development" className="link">
              <i>
                <SiMoneygram />
              </i>
          ...
          <li onClick={stopPropagationloan}>
            ...
            {showLoanMenus && (
              <ul>
                <li>
                  <Link to="/med-term-loan-transaction" className="submenu link">
                    <div className="ps-2">Medium Term</div>
                  </Link>
                </li>
                <li>
                  <Link to="/emergency-loan-transaction" className="submenu link">
                    <div className="ps-2">Emergency Loan</div>
                  </Link>
                </li>
                {/* <li>
