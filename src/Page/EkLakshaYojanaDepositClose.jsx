      ...
      <div className="container-fluid dashboard-area d-flex">
        <div className="main-content p-4">
          ...
          <div className="container d-flex text-start w-100 pb-1">
            <div className="H1-Heading-Main">Close Ek Laksha Yojana Deposit </div>
          </div>
                  ...
                  <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 text-start">
                    <div class="">
                      ...
                      <input
                        ...
                        id="accountNumber"
                        name="accountNumber"
                        value={depositData && depositData.RDID}
                        onChange={(e) => {
                      ...
                      <div>
                        <div className="row">
                          <div className="col-sm-6 mb-2">
                            <input
                              className="form-control small-label form-select small-label"
                              id="floatingInput"
                              name="deposit_period"
