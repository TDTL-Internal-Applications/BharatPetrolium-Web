...
const NeftFinalApproval = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        "http://bpcl.kolhapurdakshin.com:8000/neft_approval_bm_fetch/"
        );
  ...
  const handleApprove = async (row) => {
    try {
      ...
      const response = await axios.post(
        "http://bpcl.kolhapurdakshin.com:8000/neft_approval_by_t/",
        {
          Status: "Approved",
          user: "Trustee",
...
export default NeftFinalApproval;
